...
* what is grim                                                               
 ...
 - on the interface: _grim_ works with projects. 
   One can think of a grim project as of the dataset generation for an analysis project.
   ...
   Thus a single project may require generation of multiple datasets related to each other
...
- all dataset names look like _DDDDDbXsYZrUVCC_ with the lower case characters 
  having a special meaning and being fixed, and the upper case characters will
