...
#+begin_quote
  ...
  0.2) create ./.grid_config configuration file in the working directory for your
       project. Below, $project will stand for the project name
  ...
  4.1) after the output create input for the next stage: 
